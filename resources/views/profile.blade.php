...
{{-- <profile-component :user="{{$user}}" test="fsfsfd">
...
<form method="post" action="{{ route('saveProfile') }}" enctype="multipart/form-data">
    ...
    <div class="flex-column">
        ...
        <div class="form-group mb-3">
            ...
            <input readonly type="email" name="email" value="{{ $user->email }}" class="form-control"
        ...
        <div class="form-group mb-3">
            ...
            <ol>
                ...
                <li>
                    <label @if ($address->main) class="form-check-label h5" @endif
                        for="main_address{{$address->id}}">{{$address->address}}</label>
                    <input class="form-check-input" @if ($address->main) checked @endif
                    id="main_address{{$address->id}}" name='main_address'
        ...
        <div class="form-group mb-3">
            ...
            <div class="form-check my-3">
                <label class="form-check-label" for="main_address">Указать основным</label>
